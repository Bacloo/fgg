...
$dernierjourperiode = date('Y-m-t', strtotime($loca->getFinloc()));
...
//echo '$dernierjour'.$nbjlocmois;exit();
...
//nb jours du mois de fin loc
    $premierjourdm = date("Y-m-01", strtotime($loca->getFinloc()));//echo ' 1ERJDM'.date("Y-m-01", strtotime($loc->getFinloc()));;
    $dernierjourdm = date('Y-m-t', strtotime($loca->getFinloc()));
...
//    echo ' nbjlocdmz'.$nbjlocmois;exit();
    ...
    $begin = new DateTime($premierjourdm);// 'premierjourdm'.$premierjourdm;
    $end = new DateTime($dernierjourdm);//echo 'dernierjourdm'.$dernierjourdm;
    $end = $end->modify( '+1 day' );
