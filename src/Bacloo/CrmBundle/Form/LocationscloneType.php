...
class LocationscloneType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('typemachine', 'text', array('required' => false))
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Bacloo\CrmBundle\Entity\Locationsclone'
        ));
    }
    ...
    {
        return 'bacloo_crmbundle_locationsclone';
    }
}
