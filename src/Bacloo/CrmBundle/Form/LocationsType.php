...
class LocationsType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('loyerp1b', 'number', array('required' => false))
            ->add('loyerp2b', 'number', array('required' => false))
            ->add('loyerp3b', 'number', array('required' => false))
            ->add('loyerp4b', 'number', array('required' => false))
            ->add('loyermensuelb', 'number', array('required' => false))
            ...
            ->add('bdok', 'integer', array('required' => false))
            ->add('brok', 'integer', array('required' => false))
            ->add('bdid', 'integer', array('required' => false))
            ->add('brid', 'integer', array('required' => false))
            ->add('remise', 'number', array('required' => false))
            ->add('locdirect', 'checkbox', array('required' => false))
			;
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Bacloo\CrmBundle\Entity\Locations'
        ));
    }
    ...
    {
        return 'bacloo_crmbundle_locations';
    }
}
