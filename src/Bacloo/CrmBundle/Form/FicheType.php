...
class FicheType extends AbstractType
{
	...
	$userid = $this->userid;
        $builder
            ...
            ->add('adresse1f', 'text', array('required' => false))
            ->add('adresse2f', 'text', array('required' => false))
            ->add('cpf', 'text', array('required' => false))
            ->add('villef', 'text', array('required' => false))
            ...
            ->add('folderid', 'text', array('required' => false))
            ...
            ->add('factor', 'checkbox', array('required' => false))
            ->add('newid', 'text', array('required' => false))
            ->add('dureemoypaiement', 'integer', array('required' => false))
            ->add('troppercu', 'number', array('required' => false))
            ->add('prixcarb', 'number', array('required' => false))
            ->add('prixgnr', 'number', array('required' => false))
