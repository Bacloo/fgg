 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Bacloo\CrmBundle\Entity\LocationsfrscloneRepository")
 */
class Locationsfrsclone
{
    /**
     * @var integer
     *
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Bacloo\CrmBundle\Entity\Locatafrsclone", cascade={"persist"}, orphanRemoval=true)
     */ 		
	Private $locatafrsclone;
    ...
    {
        $this->locatafrsclone = new \Doctrine\Common\Collections\ArrayCollection();
    }
     ...
     * Add locatafrsclone
     *
     * @param \Bacloo\CrmBundle\Entity\Locatafrsclone $locatafrsclone
     *
     * @return Locationsfrsclone
     */
    public function addLocatafrsclone(\Bacloo\CrmBundle\Entity\Locatafrsclone $locatafrsclone)
    {
        $this->locatafrsclone[] = $locatafrsclone;

        return $this;
    }

    /**
     * Remove locatafrsclone
     *
     * @param \Bacloo\CrmBundle\Entity\Locatafrsclone $locatafrsclone
     */
    public function removeLocatafrsclone(\Bacloo\CrmBundle\Entity\Locatafrsclone $locatafrsclone)
    {
        $this->locatafrsclone->removeElement($locatafrsclone);
    }
     ...
     */
    public function getLocatafrsclone()
    {
        return $this->locatafrsclone;
    }
