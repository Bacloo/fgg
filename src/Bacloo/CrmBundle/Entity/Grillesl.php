...
class Grillesl
{
     ...
     * @var integer
     *
     * @ORM\Column(name="loyerp1", type="integer", nullable=true)
     */
    private $loyerp1;
     ...
     * @var integer
     *
     * @ORM\Column(name="loyerp2", type="integer", nullable=true)
     */
    private $loyerp2;
     ...
     * @var integer
     *
     * @ORM\Column(name="loyerp3", type="integer", nullable=true)
     */
    private $loyerp3;
     ...
     * @var integer
     *
     * @ORM\Column(name="loyerp4", type="integer", nullable=true)
     */
    private $loyerp4;
