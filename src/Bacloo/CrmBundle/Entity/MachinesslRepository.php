...
class MachinesslRepository extends \Doctrine\ORM\EntityRepository
{
	...
	public function dispoprecise($codemachine, $dstart, $dend, $loueur)
	{
		$qb = $this->createQueryBuilder('m');
		$qb->select('m.code');
	...
	public function dispoprecisenot($codemachine, $dstart, $dend, $loueur)
	{
		$qb = $this->createQueryBuilder('m');
		$qb->select('m.code');
		$qb->where('m.code = :code')
	...
	public function unedispo($codemachine, $dstart, $dend, $loueur)
	{
		$qb = $this->createQueryBuilder('m');
