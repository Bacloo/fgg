 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Bacloo\CrmBundle\Entity\LocationsRepository")
 */
class Locations
{
    /**
     ...
     * @var decimal
     *
     * @ORM\Column(name="loyerp1b", type="decimal", precision=12, scale=2, nullable=true)
     */
    Public $loyerp1b;
     ...
     * @var decimal
     *
     * @ORM\Column(name="loyerp2b", type="decimal", precision=12, scale=2, nullable=true)
     */
    Public $loyerp2b;
     ...
     * @var decimal
     *
     * @ORM\Column(name="loyerp3b", type="decimal", precision=12, scale=2, nullable=true)
     */
    Public $loyerp3b;
     ...
     * @var decimal
     *
     * @ORM\Column(name="loyerp4b", type="decimal", precision=12, scale=2, nullable=true)
     */
    Public $loyerp4b;
     ...
     * @var decimal
     *
     * @ORM\Column(name="loyermensuelb", type="decimal", precision=12, scale=2, nullable=true)
     */
    private $loyermensuelb;
     ...
     * @var string
     *
     * @ORM\Column(name="bduser", type="string", length=255, nullable=true)
     */
    private $bduser;
     ...
     * @var string
     *
     * @ORM\Column(name="bruser", type="string", length=255, nullable=true)
     */
    private $bruser;
     ...
     * @var boolean
     *
     * @ORM\Column(name="contrat", type="boolean", nullable=true, options={"default" : "0"})
     */
    private $contrat = 0;
     ...
     * @var integer
     *
     * @ORM\Column(name="brok", type="integer", nullable=true)
     */
    Public $brok = 0;
     ...
     * @var integer
     *
     * @ORM\Column(name="bdok", type="integer", nullable=true)
     */
    Public $bdok = 0;
     ...
     * @var integer
     *
     * @ORM\Column(name="brid", type="integer", nullable=true)
     */
    Public $brid = 0;
     ...
     * @var integer
     *
     * @ORM\Column(name="bdid", type="integer", nullable=true)
     */
    Public $bdid = 0;
     ...
     * @var string
     *
     * @ORM\Column(name="prochainevgp", type="string", length=255, nullable=true)
     */
     ...
     * @var decimal
     *
     * @ORM\Column(name="locdirect", type="boolean", length=255, nullable=true)
     */
    Public $locdirect;
     ...
     *
     * @param string $daterelancereprise
     *
     * @return Locations
     */
     ...
     * @return Locations
     */
    public function setBduser($bduser)
    {
        $this->bduser = $bduser;
     ...
     * @return Locations
     */
    public function setBruser($bruser)
    {
        $this->bruser = $bruser;
     ...
     * Set locdirect
     *
     * @param boolean $locdirect
     *
     * @return Locations
     */
    public function setLocdirect($locdirect)
    {
     ...
     * @return boolean
     */
    public function getLocdirect()
    {
        return $this->locdirect;
    }

    /**
     * Set loyerp1b
     *
     * @param string $loyerp1b
     *
     * @return Locations
     */
    public function setLoyerp1b($loyerp1b)
    {
        $this->loyerp1b = $loyerp1b;
     ...
     * @return string
     */
    public function getLoyerp1b()
    {
        return $this->loyerp1b;
    }

    /**
     * Set loyerp2b
     *
     * @param string $loyerp2b
     *
     * @return Locations
     */
    public function setLoyerp2b($loyerp2b)
    {
        $this->loyerp2b = $loyerp2b;
     ...
     * @return string
     */
    public function getLoyerp2b()
    {
        return $this->loyerp2b;
    }

    /**
     * Set loyerp3b
     *
     * @param string $loyerp3b
     *
     * @return Locations
     */
    public function setLoyerp3b($loyerp3b)
    {
        $this->loyerp3b = $loyerp3b;
     ...
     * @return string
     */
    public function getLoyerp3b()
    {
        return $this->loyerp3b;
    }

    /**
     * Set loyerp4b
     *
     * @param string $loyerp4b
     *
     * @return Locations
     */
    public function setLoyerp4b($loyerp4b)
    {
        $this->loyerp4b = $loyerp4b;
     ...
     * @return string
     */
    public function getLoyerp4b()
    {
        return $this->loyerp4b;
    }

    /**
     * Set loyermensuelb
     *
     * @param string $loyermensuelb
     *
     * @return Locations
     */
    public function setLoyermensuelb($loyermensuelb)
    {
        $this->loyermensuelb = $loyermensuelb;
     ...
     * @return string
     */
    public function getLoyermensuelb()
    {
        return $this->loyermensuelb;
    }
}
