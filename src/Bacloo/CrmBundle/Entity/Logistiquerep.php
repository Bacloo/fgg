 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Bacloo\CrmBundle\Entity\LogistiquerepRepository")
 */
class Logistiquerep
{
    /**
	...
	*/		
	...
	/**
	* @ORM\ManyToMany(targetEntity="Bacloo\CrmBundle\Entity\Logisrep", cascade={"persist"}, orphanRemoval=true)
	*/		
	Private $logisrep;
    ...
    {
        $this->logisrep = new \Doctrine\Common\Collections\ArrayCollection();
    }

    /**
     * Add logisre
     *
     * @param \Bacloo\CrmBundle\Entity\Logisrep $logisre
     *
     * @return Logistiquerep
     */
    public function addLogisre(\Bacloo\CrmBundle\Entity\Logisrep $logisre)
    {
        $this->logisrep[] = $logisre;
     ...
     * @param \Bacloo\CrmBundle\Entity\Logisrep $logisre
     */
    public function removeLogisre(\Bacloo\CrmBundle\Entity\Logisrep $logisre)
    {
        $this->logisrep->removeElement($logisre);
    }
     ...
     */
    public function getLogisrep()
    {
        return $this->logisrep;
    }
     ...
     * Add logisrep
     *
     * @param \Bacloo\CrmBundle\Entity\Logisrep $logisrep
     *
     * @return Logistiquerep
     */
    public function addLogisrep(\Bacloo\CrmBundle\Entity\Logisrep $logisrep)
    {
        $this->logisrep[] = $logisrep;
     ...
     * @param \Bacloo\CrmBundle\Entity\Logisrep $logisrep
     */
    public function removeLogisrep(\Bacloo\CrmBundle\Entity\Logisrep $logisrep)
    {
        $this->logisrep->removeElement($logisrep);
    }
}
